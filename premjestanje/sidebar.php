            ...
            <div class="navbar-content">
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="artikalkutija.php">Artikal - Kutija</a> </li>
                            <li class="nxl-item"><a class="nxl-link" href="kutijapaleta.php">Kutija - Paleta</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="paletaregal.php">Paleta - Regal</a></li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
